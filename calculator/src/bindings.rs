    ...
    pub mod subtract {
      ...
      pub fn subtract(a: i32,b: i32,) -> i32{
        ...
        unsafe {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "docs:calculator/subtract@0.1.0")]
          extern "C" {
            #[link_name = "subtract"]
            fn wit_import(_: i32, _: i32, ) -> i32;
          }
      ...
      pub mod calculate {
        ...
        const _: () = {
          ...
          unsafe extern "C" fn __export_eval_expression(arg0: i32,arg1: i32,arg2: i32,) -> i32 {
            ...
            let result0 = <_GuestImpl as Guest>::eval_expression(Op::_lift(arg0 as u8), arg1, arg2);
